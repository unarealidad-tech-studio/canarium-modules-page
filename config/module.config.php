	...
	'bjyauthorize' => array(
        'guards' => array(
            'BjyAuthorize\Guard\Route' => array(
				array('route' => 'admin/page', 'roles' => array('admin')),
				array('route' => 'permalink', 'roles' => array('user','guest')),
				array('route' => 'admin/attachment', 'roles' => array('admin')),
            ),
			'BjyAuthorize\Guard\Controller' => array(
				array('controller' => 'Admin\Page',array(), 'roles' => array('admin')),
				array('controller' => 'Admin\Page\Attachment',array(), 'roles' => array('admin')),
				array('controller' => 'Page',array(), 'roles' => array('guest','user')),
            ),
        ),
    ),
